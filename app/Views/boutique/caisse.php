...
<section class="caisse">
    ...
    <div class="caisse-grid">
        ...
        <form class="panel caisse-form" method="post" action="<?= e(url('/boutique/' . $boutique['slug'] . '/commander')) ?>" data-submit-once>
            ...
            <!-- Étape 1 — Réception -->
            <section class="caisse-step">
                <h3 class="caisse-step__h"><span class="caisse-step__n">1</span> <?= e(t('caisse.step_receive')) ?></h3>
                <?php if ($fulfillments): ?>
            ...
            <!-- Étape 2 — Paiement -->
            <section class="caisse-step">
                <h3 class="caisse-step__h"><span class="caisse-step__n">2</span> <?= e(t('caisse.step_pay')) ?></h3>
                <?php if ($terms): ?>
                ...
                <?php endif; ?>
                <?php
                // Opérateur mobile money / carte selon le PAYS de l'acheteur (sélectionnable).
            ...
            <!-- Étape 3 — Coordonnées -->
            <section class="caisse-step">
                <h3 class="caisse-step__h"><span class="caisse-step__n">3</span> <?= e(t('order.f.your_details')) ?></h3>
                <?php if (empty($me)): ?>
