    ...
    <div class="contact-grid">
        <?php foreach (ContactChannels::CHANNELS as $ch): ?>
            ...
            <div class="contact-field">
                <label for="contact-<?= e($ch) ?>"><img class="social-logo-sm" src="<?= e(\App\Services\ContactChannels::logo($ch)) ?>" alt="" width="20" height="20"> <?= e($m['label']) ?></label>
    ...
    <div class="lang-checks">
        <?php foreach (ContactChannels::CHANNELS as $ch): $m = ContactChannels::meta($ch); ?>
            <label class="check-pill">
                ...
                <span><img class="social-logo-sm" src="<?= e(\App\Services\ContactChannels::logo($ch)) ?>" alt="" width="18" height="18"> <?= e($m['label']) ?></span>
            </label>
        <?php endforeach; ?>
    </div>
