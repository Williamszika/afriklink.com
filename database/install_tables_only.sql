-- Afriklink — TABLES seulement (variante sans CREATE DATABASE / USE).
-- À utiliser si l'éditeur SQL de TiDB renvoie une erreur avec install.sql.
-- Étapes : 1) crée la base 'afrikalink' (bouton de l'UI), 2) sélectionne-la
--          dans le menu déroulant de l'éditeur, 3) colle CECI et exécute.
