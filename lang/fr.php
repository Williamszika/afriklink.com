...
return [
    ...
    // Inscription professionnelle (assistant 3 étapes)
    'pro.title'        => 'Inscription professionnelle',
    'pro.subtitle'     => 'Crée le compte de ton entreprise en 3 étapes. Tu choisiras ensuite quoi ouvrir : boutique, restaurant, salon ou services.',
    ...
    'pro.next'         => 'Continuer',
    'pro.back'         => 'Retour',
    'pro.submit'       => 'Créer mon compte professionnel',
    ...
    'pro.field.reg_number_trust'  => 'Le numéro d’enregistrement est facultatif pour s’inscrire, mais il permet d’obtenir le badge « Pro vérifié » sur ta vitrine — les clients achètent plus volontiers chez un pro vérifié.',
    ...
    'pro.dash.badge_pro'        => 'Professionnel',
    'pro.dash.badge_verified'   => 'Pro vérifié',
    'pro.dash.badge_pending'    => 'Vérification en cours',
    'pro.dash.pending_note'     => 'Ton entreprise est en cours de vérification. Tu peux déjà tout préparer — le badge « Pro vérifié » apparaîtra après contrôle de ton numéro d’enregistrement.',
